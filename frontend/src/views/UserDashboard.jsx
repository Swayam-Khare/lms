...
export default function UserDashboard() {
      ...
      const dummyIssueRecords = [
        {
          ...
          books: [{ bookName: "Book A", bookId: 101 }, { bookName: "Book B", bookId: 102 }],
        },
        {
          id: 2,
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6 relative">
      ...
      <div className="relative max-w-7xl mx-auto bg-white bg-opacity-80 backdrop-blur-md shadow-lg rounded-lg p-8 mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 text-center">
            <h2 className="text-2xl font-semibold text-gray-700">Books Issued</h2>
            <p className="text-6xl font-bold text-green-700 mt-4">{userData.booksIssued}</p>
            <p className="text-gray-500 mt-2">Total number of books you have issued</p>
          </div>

          {/* Card 2: Total Fine Amount */}
          <div className="bg-white shadow-lg rounded-lg p-6 text-center">
            <h2 className="text-2xl font-semibold text-gray-700">Total Fine</h2>
            <p className="text-6xl font-bold text-red-600 mt-4">₹{userData.totalFine}</p>
            <p className="text-gray-500 mt-2">Total accumulated fine for overdue books</p>
          </div>

          {/* Card 3: Next Return Date */}
          <div className="bg-white shadow-lg rounded-lg p-6 text-center" >
            <h2 className="text-2xl font-semibold text-gray-700">Next Return Date</h2>
            <p className="text-4xl font-bold text-blue-600 mt-6">
              {userData.nextReturnDate ? new Date(userData.nextReturnDate).toLocaleDateString() : "N/A"}
            </p>
            <p className="text-gray-500 mt-5">The return date for your next due book</p>
          </div>
        </div>

        {/* Render IssueRecordList Component */}
        <div className="bg-white shadow-lg rounded-lg p-6 text-center" >
            <h2 className="text-2xl font-semibold text-gray-700 mb-6">Current Issued Books</h2>
            <IssueRecordList 
